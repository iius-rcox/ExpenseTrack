...
/// <summary>
/// Validator for CreateReportJobRequest.
/// </summary>
public class CreateReportJobRequestValidator : AbstractValidator<CreateReportJobRequest>
{
    public CreateReportJobRequestValidator()
    {
        RuleFor(x => x.Period)
            .NotEmpty()
            .WithMessage("Period is required")
            .Matches(@"^\d{4}-(0[1-9]|1[0-2])$")
            .WithMessage("Period must be in YYYY-MM format (e.g., 2026-01)")
            .Must(BeValidPeriod)
